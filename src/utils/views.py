...
class BaseConfirmView(discord.ui.View):
    ...
    def __init__(self, *, timeout: int = 30, confirm_label: str = "✅ Confirm", cancel_label: str = "❌ Cancel"):
...
class ResetConfirmView(BaseConfirmView):
    ...
    async def confirm(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.edit_message(content="Reset confirmed. Clearing all XP...", view=None)
        self.value = True
        self.stop()
