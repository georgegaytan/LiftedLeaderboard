...
3. **Error Handling**: Instructions for scripts should be "black boxes" for the agent to run `-help` if they are unsure.
...
2. **Upload this file** to your Al agent or paste it into the system prompt area.
